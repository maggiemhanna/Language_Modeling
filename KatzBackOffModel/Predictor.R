...
function(unigram = ngram.1, remove_words = NULL){
...
function(word1, bigram = ngram.2,  remove_words = NULL){
...
function(word1, word2, trigram = ngram.3, remove_words = NULL) {
...
function(word1, word2, word3, fourgram = ngram.4, remove_words = NULL) {
